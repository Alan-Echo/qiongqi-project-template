package com.qiongqi.prj.template.config.security;

import com.qiongqi.prj.template.config.Filtter.JWTAuthorizationFilter;
import com.qiongqi.prj.template.config.Filtter.ValidateCaptchaFilter;
import com.qiongqi.prj.template.config.security.handler.MyAuthenticationEntryPoint;
import com.qiongqi.prj.template.config.security.handler.MyAuthenticationFailureHandler;
import com.qiongqi.prj.template.config.security.handler.MyAuthenticationSuccessHandler;
import com.qiongqi.prj.template.config.security.handler.MyLogoutSuccessHandler;
import com.qiongqi.prj.template.config.security.service.UserDetailsServiceImpl;
